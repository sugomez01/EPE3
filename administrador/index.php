...
if (!isset($_SESSION['nombre'])) {
	...
	$sentencia = $bd->query("SELECT a1.*,a2.id_user as user_emp FROM compra a1 left join servicio a2 on a1.id_ser = a2.id_ser order by fecha_comp desc"); //aqui se agrega el servicio a filtrar por base de datos
				...
				<div class="col">
					<table class="table table-striped table-bordered table-hover table-light">
						...
						<tbody>
							...
							?>
								<tr id="<?php echo $dato->id_comp; ?>">
									<td><?php echo $dato->id_com; ?></td>
									<td><?php echo $dato->fecha_comp; ?></td>
									<td><?php echo $dato->cant; ?></td>
									<td><?php echo $dato->valor_total; ?></td>
									<td><?php echo $dato->id_user; ?></td>
									<td><?php echo $dato->user_emp; ?></td>
								</tr>
							<?php } ?>
						</tbody>
						</tbody>
